...
/*
Enoque e Leonardo encontraram um tesouro secreto no campus de Quixadá. O tesouro é composto por n itens de valores v1,v2,...,vn. Eles querem saber se é possível particionar os itens do tesouro em dis subconjutnos de tal maneira que ambos recebam o mesmo valor. Por exemplo, se eles encontrarem um tesouro composto por 4 itens de valores 5, 11, 5, 1. Esse tesouro pode ser particionado como {5, 5, 1} e {11}.

Escreva o código, utilizando programação dinamica, que resolva o problema.
